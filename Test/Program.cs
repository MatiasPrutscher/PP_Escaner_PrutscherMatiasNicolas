...
namespace Test
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Libro l3 = new Libro("Yerma", "García Lorca, Federico", 1995, "1114", "22222", 27);
            ...
            Escaner mapoteca = new Escaner("hp", TipoDoc.mapa);
            Escaner procesosTecnicos = new Escaner("epson", TipoDoc.libro);
            bool a = mapoteca + m1;
            a = mapoteca + l5;
            a = mapoteca + m2;
            a = mapoteca + m3;
